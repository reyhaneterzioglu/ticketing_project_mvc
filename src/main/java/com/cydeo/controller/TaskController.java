...
public class TaskController {
    ...
    @PostMapping("/create")
    public String insertTask(@Valid @ModelAttribute("task") TaskDTO task, BindingResult bindingResult, Model model) { //@ModelAttribute("task")
...
//    }
    ...
    // only with post mapping ;
    // if the {id} is same name as the field name which is Long id in Task class, spring does the parsing automatically without @PathVariable
